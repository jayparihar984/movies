...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9653)), "/home/atm/Desktop/my-movies/src/app/not-found.jsx"],
    ...
    const originalPathname = "/movies/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/movies/page","pathname":"/movies","bundlePath":"app/movies/page","filename":"","appPaths":[]}}
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                ...
                children: movie.publishing_year
            })
        ]
    });
}
...
var Pagination = __webpack_require__(2597);
// EXTERNAL MODULE: ./node_modules/axios/lib/axios.js + 48 modules
var axios = __webpack_require__(4997);
;// CONCATENATED MODULE: ./src/app/movies/page.jsx
...
/*export async function loadTasks() {
  ...
  return movies;
    ...
    const [movies, setMovies] = (0,react_.useState)([]);
    const [noRecord, setNoRecord] = (0,react_.useState)(false);
    const router = (0,navigation.useRouter)();
    const [activePage, setActivePage] = (0,react_.useState)(1);
    const [tottalItem, setTottalItem] = (0,react_.useState)(0);
    const [perPage, setPerPage] = (0,react_.useState)(0);
    ...
    const getMovies = async ()=>{
        ...
        axios/* default */.Z.post("/api/movies", fd).then(function(response) {
            setMovies(response.data.data);
            setTottalItem(response.data.total_count);
            setNoRecord(true);
        }).catch(function(error) {});
