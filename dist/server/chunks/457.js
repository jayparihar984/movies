...
/* harmony import */ var react_icons_ri__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(418);
...
const NewTask = ()=>{
    ...
    const getTask = async ()=>{
        ...
        axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z.post(`/api/movies/${params.id}`, {}, {
            headers: {
    ...
    const createTask = async ()=>{
        ...
        axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z.post("/api/movies", fd, {
            headers: {
                Authorization: `Bearer ${localUser?.token}`
            }
        }).then(function(response) {
    ...
    const updateTask = async ()=>{
        ...
        fd.append("publishing_year", newTask.publishing_year);
        fd.append("file", newTask.file);
        axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z.put(`/api/movies/${params.id}`, fd, {
            headers: {
                Authorization: `Bearer ${localUser?.token}`
            }
        }).then(function(response) {
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("label", {
                                        ...
                                        children: [
                                            newTask.file == "" && newTask.editFile == "" && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                                                children: [
                                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_icons_ri__WEBPACK_IMPORTED_MODULE_4__/* .RiDownload2Line */ .VxU, {
                                            ...
                                            newTask.file == "" && newTask.editFile != "" && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("img", {
                                                width: "90%",
                                                src: "http://192.168.29.110:3000/" + "uploads/" + newTask.editFile
                                            })
                                        ]
                                    }),
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            isSubmitting == true ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                                variant: "success",
                                                size: "lg",
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/atm/Desktop/my-movies/src/app/movies/new/page.jsx`)
